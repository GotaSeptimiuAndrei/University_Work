...
public class Parser {
    ...
    private int i;
    // stores derivation steps during parsing, including information about which production rules are applied
    private Stack<String> alpha;
    // stores the symbols that are yet to be matched (remaining derivation symbols)
    private Stack<String> beta;
    // holds the final sequence of derivations (used for producing the derivation string)
    ...
    // Try next production for the current non-terminal

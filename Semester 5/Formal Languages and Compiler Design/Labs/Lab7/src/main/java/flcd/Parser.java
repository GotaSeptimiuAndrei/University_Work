...
public class Parser {
    ...
    public void descendingRecursiveParsing(){
        ...
        if(state.equals("f")){
            ...
            if(onPif){
                parserOutput = new ParserOutput(grammar, alpha, "src/main/java/flcd/out/out2.txt");
            }
            else {
                parserOutput = new ParserOutput(grammar, alpha, "src/main/java/flcd/out/out1.txt");
            }

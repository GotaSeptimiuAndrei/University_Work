...
import pdp.Algorithms.ParallelClassic;
import pdp.Algorithms.ParallelKaratsuba;
import pdp.Algorithms.SequentialClassic;
import pdp.Algorithms.SequentialKaratsuba;
import pdp.Model.AlgorithmChoice;
import pdp.Model.MethodChoice;
import pdp.Model.Polynomial;
...
public class Main {
    private static final MethodChoice METHOD = MethodChoice.SEQUENTIAL;
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException, IOException {
        ...
        BufferedWriter out = new BufferedWriter(
                new FileWriter("src/main/resources/results.txt", true));

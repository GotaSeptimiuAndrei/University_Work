...
def generate_random_graph(n, m, file_path):
    ...
    the interval [-1.000.000, 1.000.000]. If the number of edges is invalid an error will be raised. The graph will be written in
    ...
    while len(edges) < m:
        x = str(randrange(n))
        y = str(randrange(n))
        cost = str(randrange(-1000000, 1000000))

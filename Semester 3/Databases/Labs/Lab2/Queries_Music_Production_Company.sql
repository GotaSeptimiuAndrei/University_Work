...
INSERT INTO Manager (
	...
	(1, 'John Doe', '1234567890', 'johndoe@gmail.com', 'Harvard University', 9000),
	(2, 'Jane Smith', '9876543210', 'janesmith@gmail.com', 'Stanford University', 8500),
	(3, 'Robert Johnson', '5551234567', 'robertjohnson@gmail.com', 'Yale University', 8200),
	(4, 'Emily Davis', '4449876543', 'emilydavis@gmail.com', 'Princeton University', 8300),
	(5, 'Michael Wilson', '7778889999', 'michaelwilson@gmail.com', 'MIT', 9200),
	(6, 'Laura Lee', '1112223333', 'lauralee@gmail.com', 'Columbia University', 8700)
;
...
INSERT INTO Song (
	...
	(1, 'Domino', 'pop', '2011-12-26', 3, 1487130, 540004),
	(2, 'Do It Like A Dude', 'pop', '2010-11-09', 5, 759278, 45230),
	(3, 'MAMMA MIA', 'rock', '2021-10-11', 2, 411521,9559),
	(4, 'ZITTI E BUONI', 'rock', '2021-04-03', 2, 1587834, 40365),
	(5, 'Torna a casa', 'rock', '2018-10-01', 5, 1143363, 39006),
	(6, 'Fly', 'country', '2015-02-23', 4, 236320, 8226),
	(7, 'Fergalicious', 'pop', '2009-06-17', 3, 1361082, 54119),
	(8, 'Clumsy', 'pop', '2009-06-17', 4, 418318,  12288),
	(9, 'No Ordinary', 'pop', '2020-10-09', 6, 94342, 509),
	(10, 'All For Us', 'pop', '2019-08-05', 3, 272783, 4696)
;
...
INSERT INTO Composer (
	...
	(1, 'Tiffany Vartanyan', '0765289654', 'tiffvart@gmail.com', 5900, 'guitar', 3),
	(2, 'Kim Nazel', '0716985465', 'kimnizel@gmail.com', 6400, NULL, 5),
	(3, 'Jake Sinclair', '0735984257', 'jakesin@gmail.com', 3000, 'violin', 4),
	(4, 'Jimmy Forrest', '0716952046', 'jimmyforrest@gmail.com', 4410, 'drums', 2)
;
...
--update the salary of the manager with the manager_id=3 to 10000
SELECT *
FROM Manager;

UPDATE Manager 
SET manager_salary = 10000
WHERE manager_id = 3; -- used =
...
UPDATE Fan 
SET fan_age = fan_age+1 
WHERE fan_country IN ('UK', 'Germany', 'US') AND fan_age BETWEEN 19 AND 30; -- used AND, IN, BETWEEN

SELECT *
FROM Fan;

--update the prefered_intrument of a composer that has it set to null
SELECT *
FROM Composer;

UPDATE Composer
SET prefered_instrument = 'multi-instrumentalist composer'
WHERE prefered_instrument IS NULL; -- used IS NULL
...
FROM Composer C 
WHERE C.manager_id = 3 --used UNION

SELECT DISTINCT  M.manager_name
FROM Manager M, Singer S, Composer C
WHERE (M.manager_id = S.manager_id AND S.type_of_voice = 'tenor') OR (M.manager_id = C.manager_id AND C.prefered_instrument = 'guitar') -- used DISTINCT and OR
...
FROM Lyrist L --used INTERSECT

SELECT C.composer_name 
FROM Composer C 
WHERE C.composer_name IN (SELECT L.lyrist_name FROM Lyrist L) -- used IN
...
FROM Fan_of_singer FS -- used EXCEPT and WHERE

SELECT S.song_name 
FROM Song S
WHERE (S.song_genre = 'pop' OR S.song_genre = 'rock') AND S.song_name NOT IN (SELECT FS.favourite_song FROM Fan_of_singer FS) --used NOT IN
...
--Print the name of singers which have fans that have as a favourite song a song longer than 3 minutes with reviews.
...
WHERE S.singer_id IN (
	...
	WHERE FS.favourite_song IN (
		SELECT SG.song_name 
		FROM Song SG
		WHERE NOT SG.duration < 3 AND SG.song_id IN (
...
--Find the top 50% producers for which half of the experience is more than the experience of the producers with a salary smaller than 15000
--using ALL

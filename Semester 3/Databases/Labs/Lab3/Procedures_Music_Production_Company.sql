...
GO
CREATE OR ALTER PROCEDURE setManagerSalaryFromIntegerToDecimal
AS
    ALTER TABLE Manager ALTER COLUMN manager_salary FLOAT

GO
CREATE OR ALTER PROCEDURE setManagerSalaryBackToInteger
AS
	ALTER TABLE Manager ALTER COLUMN manager_salary INT
...
VALUES
	(1, 2, 'setManagerSalaryFromIntegerToDecimal'),
	(2, 1, 'setManagerSalaryBackToInteger'),
